...
int main() {
    ...
    float interest ;
    printf("Enter initialBalance, Penalty_fee and N_periods:") ;
    ...
    for ( i = 1; i <= N_PERIODS; i++ ) {
        ...
        switch ( cmdCode ) {
            ...
            case 3:
                ...
                if ( currentBalance <= 600.00 ) {
                    interest = currentBalance * ( 0.01 / 12.0 ) ;
                    printf( "Interest: %.2f (Rate: 1.00%%)\n", interest ) ;
                } else {
                    interest = currentBalance * ( 0.025 / 12.0 ) ;
                    printf( "Interest: %.2f (Rate: 2.50%%)\n", interest ) ;
                }
